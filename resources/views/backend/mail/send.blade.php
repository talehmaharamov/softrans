...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <!-- LOGO -->
    <tr>
        <td bgcolor="#d84801" align="center">
    ...
    <tr>
        <td bgcolor="#d84801" align="center" style="padding: 0px 10px 0px 10px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                <tr>
                  ...
                  letter-spacing: 4px;
                  line-height: 48px;">
                        <img src="https://i.ibb.co/VtyJ2RZ/logo.png" width="125" height="120"
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 30px 10px 0px 10px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                ">
                        ...
                        <p style="margin: 0">
                            <a href="{{ route('frontend.contact-us-page') }}" target="_blank" style="color: #d84801">
