                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-4">
                            <img class="me-3 rounded-circle avatar-sm" src="{{asset('backend/images/users/mail.png')}}"
                        ...
                        <div>
                            ...
                            <h5>@lang('backend.email'): <a href="mailto:{{ $message->email }}">{{ $message->email }}</a>
                            </h5>
                        </div>
                        <p>
                            {{ $message->message }}
                        </p>
                        <a href="mailto:{{ $message->email }}" class="btn btn-secondary waves-effect mt-4"><i
